            ...
            <div className="container">
                {logolight === true ? 
                    <Link className="logo" href="/">
                        <span className="logo-light-mode">
                            <Image src='/images/logo.png' width={200} height={32} className="l-dark" alt=""/>
                            <Image src='/images/logo.png' width={200} height={32} className="l-light" alt=""/>
                        </span>
                        <Image src='/images/logo.png' width={200} height={32} className="logo-dark-mode" alt=""/>
                    </Link> :
                    <Link className="logo" href="/">
                        <Image src='/images/logo.png' width={200} height={32} className="logo-light-mode" alt=""/>
                        <Image src='/images/logo.png' width={200} height={32} className="logo-dark-mode" alt=""/>
                    </Link>
                }
                ...
                <div id="navigation" style={{ display: isMenu ? 'block' : 'none' }}>
                    <ul className={menuClass}>
                        ...
                        <li><Link href="/contactus" className="sub-menu-item"> تواصل معنا</Link></li>
                    </ul>
                </div>
            </div>
        </header>
